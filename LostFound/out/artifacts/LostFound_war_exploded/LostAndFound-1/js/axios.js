...
axios.interceptors.request.use(function(config){
    ...
    if(token && token!=null && token!=""){
        ...
        var success1 = "login";
        var success2 = "index";
        var success3 = "article";
        var success4 = "logReg";
        if(nowURL.indexOf(success1)!=-1||nowURL.indexOf(success2)!=-1||nowURL.indexOf(success3)!=-1||nowURL.indexOf(success4)!=-1){
            flag=0;
        }
        if(flag){
            //layer.msg("请先登录哦！");
...
axios.interceptors.response.use(function (response) {
    ...
    // 对响应错误做点什么
    // console.log("response错误！"+error.response.status+"--"+error);
    console.log("response错误")
    layer.msg('登录过期，请您重新登录！', {
        icon: 2,
        time: 3*1000,
        shift: 6
    });
...
// axios.defaults.baseURL="http://lost.piplong.cn:8086"
