...
<div class="house">
    ...
    <div class="detail">
        <div class="left">
            <img src="<%=basePath%>/${sessionScope.lostGoodsList1[0].i_img}" alt="">
        </div>
        <div class="right">
            <div class="layout goodsname">[失物招领]</div>
            <div class="layout">物品类别:${sessionScope.lostGoodsList1[0].i_typename}</div>
            <div class="layout">启事详情:${sessionScope.lostGoodsList1[0].i_sort}</div>
            <div class="layout">发现地点:${sessionScope.lostGoodsList1[0].i_place}</div>
            <div class="layout">发现时间:${sessionScope.lostGoodsList1[0].i_time}</div>
...
<div id="claim" class="claim">
    <div class="clabox">
        <div class="claimlayout name">联系姓名:${sessionScope.lostGoodsList1[0].i_loster}</div>
        <div class="claimlayout phone">联系电话:${sessionScope.lostGoodsList1[0].i_telephone}</div>
        <div class="claimlayout">请尽快联系拾主取回失物</div>
    </div>
