...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form layui-col-space5" enctype= "multipart/form-data" method="post" action="">
            <input type="hidden" id="img" name="img" value="${lostGoods.i_img}" >
            <input type="hidden" name="id" value="${lostGoods.i_id}">
            <input type="hidden" name="typeIds" id="typeIds" value="${lostGoods.i_feature}">
            <div class="layui-form-item">
                <label for="goodsname" class="layui-form-label">
                    <span class="x-red">*</span>物品名称</label>
                <div class="layui-input-inline">
                    <input type="text" id="goodsname" name="goodsname" value="${lostGoods.i_name}" required="" autocomplete="off" class="layui-input"></div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入内容" id="desc" name="desc" class="layui-textarea" >${lostGoods.i_sort}</textarea>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div class="layui-upload-drag" id="test10">
                        ...
                        <div class="layui-hide" id="uploadDemoView">
                            <hr>
                            <img src="<%=basePath2%>/${lostGoods.i_img}" alt="上传成功后渲染" style="max-width: 196px">
                        </div>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <label for="lostaddress" class="layui-form-label">
                    <span class="x-red">*</span>发现地点</label>
                <div class="layui-input-inline">
                    <input type="text" id="lostaddress" name="lostaddress" value="${lostGoods.i_place}" required=""  autocomplete="off" class="layui-input"></div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span></div>
            </div>
            <div class="layui-form-item">
                <label for="losttime" class="layui-form-label"><span>*</span>发现时间</label>
                <div class="layui-input-block">
                    <div class="layui-inline layui-show-xs-block">
                        <input class="layui-input"  autocomplete="off" value="${lostGoods.i_time}" placeholder="" name="losttime" id="losttime">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="nikename" disabled name="nikename" value="${lostGoods.i_loster}" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span></div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="phone" name="phone" value="${lostGoods.i_telephone}" lay-verify="phone" required=""  autocomplete="off" class="layui-input"></div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span></div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form','upload', 'layer','laydate'],
        function() {
            ...
            upload.render({
                elem: '#test10'
                ,url: '<%=basePath%>LostServlet?op=upload' //此处用的是第三方的 http 请求演示，实际使用时改成您自己的上传接口即可。
                ,done: function(res){
                    layer.msg('上传成功');
            ...
            form.on('submit(update)', function(data){
                ...
                var data=data.field;
                $.ajax({
                    url:"<%=basePath%>/LostServlet?op=update",
                    type:"post",
                    data:data,
